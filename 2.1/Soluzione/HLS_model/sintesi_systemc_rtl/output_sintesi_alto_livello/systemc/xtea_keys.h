...
#ifndef __xtea_keys_H__
#define __xtea_keys_H__
...
struct xtea_keys_ram : public sc_core::sc_module {
...
xtea_keys_ram* meminst;


SC_CTOR(xtea_keys) {
meminst = new xtea_keys_ram("xtea_keys_ram");
