...
architecture behav of xtea is 
    ...
    "xtea,hls_ip_2018_2_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.656000,HLS_SYN_LAT=66,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=628,HLS_SYN_LUT=1606,HLS_VERSION=2018_2_2}";
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_1_fu_254_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                v0_3_reg_230 <= v0_reg_168;
            elsif (((tmp_fu_522_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_1_fu_254_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_fu_522_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, tmp_1_fu_254_p2, ap_CS_fsm_state4, tmp_fu_522_p2, mode_read_read_fu_90_p2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state4 => 
                if (((tmp_fu_522_p2 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state4))) then
                    ap_NS_fsm <= ap_ST_fsm_state6;
                else
    ...
    or_cond2_fu_702_p2 <= (tmp_16_fu_666_p2 or sel_tmp7_fu_690_p2);
    or_cond3_fu_438_p2 <= (tmp_26_fu_402_p2 or sel_tmp6_fu_426_p2);
    or_cond_fu_306_p2 <= (tmp_5_fu_270_p2 or sel_tmp2_fu_294_p2);
    ...
    tmp_20_fu_346_p2 <= (tmp_44_fu_342_p1 xor tmp_43_fu_326_p2);
    ...
    tmp_32_fu_752_p2 <= (tmp_36_fu_748_p1 xor tmp_29_fu_732_p2);
    ...
    tmp_36_fu_748_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_31_fu_738_p4),32));
    tmp_37_fu_266_p1 <= sum_reg_146(2 - 1 downto 0);
    tmp_38_fu_474_p4 <= v0_2_fu_462_p2(31 downto 5);
    tmp_39_fu_488_p2 <= (tmp_49_fu_484_p1 xor tmp_48_fu_468_p2);
    ...
    tmp_44_fu_342_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_19_fu_332_p4),32));
    ...
    tmp_49_fu_484_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_38_fu_474_p4),32));
